...
def download_report(request):
    ...
    try:
        ...
        prediction = float(data.get('prediction', 0))  # Default to 0 if not provided or invalid
        ...
        table_data = [
            ...
            ['Smoker', str(smoker)],
            ['Region', str(region)],
            ['Predicted Insurance Cost', f"${prediction:.2f}"]  # Format prediction to 2 decimal places
        ]
