...
responses = {
    "How do I calculate my insurance cost?": "You can calculate your insurance cost using our prediction system. Please provide your details such as age, sex, BMI, etc.",
    "What is BMI?": "BMI stands for Body Mass Index, a measure of body fat based on height and weight.",
    "What is a smoker discount?": "A smoker discount may be available based on your smoking habits, which affect the insurance cost prediction."
}
