...
def download_report(request):
    ...
    title = Paragraph("Medical Insurance Cost Prediction System", getSampleStyleSheet()['Title'])
    ...
    # Create a Table
    table = Table(table_data, colWidths=[200, 300])  # Make the table wider by adjusting column widths
    ...
    table.setStyle(TableStyle([
        ...
        ('ALIGN', (1, 0), (-1, -1), 'LEFT'),  # Left-align the content
    ]))
