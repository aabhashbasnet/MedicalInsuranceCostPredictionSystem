...
import { useUser } from '../context/UserContext';  // Use the hook here
...
const InsuranceForm = () => {
  ...
  if (!user) {
    // If the user is not logged in, you can display a message or redirect them
    return <p>Please login to view the prediction.</p>;
  }
